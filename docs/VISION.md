...
**Project Nobi** is building Nori — a personal AI companion that remembers you, grows with you, and belongs to you. No corporation controls it. No subscription gates it. No single point of failure can take it away.

Nori is not a chatbot. It's not a productivity tool wearing a personality. It's a companion — designed from the ground up to know you deeply, to recall the texture of your life, and to be there across years, not just sessions.
...
Bittensor is a decentralized network of AI services, where independent operators (miners) compete to provide the best intelligence, scored by validators, and rewarded with TAO — the network's native token. It is, in essence, a market mechanism for AI quality.
...
Miners earn TAO proportional to the quality of their companion responses. Better memory recall, warmer personality, faster responses — all measured, all rewarded. Bad miners earn nothing and get replaced. The market optimizes for you, the user, automatically and continuously.
...
Your companion should reflect YOUR values, not a content policy designed for the lowest common denominator of a global user base. Decentralized infrastructure means no single entity decides what your companion can or cannot discuss with you — within the bounds of law and safety.
...
Traditional AI companies follow a predictable arc: raise VC money → acquire users with a free product → introduce subscriptions → raise prices → optimize for revenue per user → your interests and theirs diverge.
...
*Written for humans, not engineers. Technical details in our [Whitepaper](WHITEPAPER.md) and [Subnet Design](SUBNET_DESIGN.md).*
...
When you tell Nori about your day, it doesn't just respond — it remembers. It extracts the important things: people you mentioned, emotions you expressed, events that happened, preferences you revealed. These become part of your **memory graph** — a rich, interconnected web of everything Nori knows about you.

Six months later, when you mention being nervous about something, Nori might recall: "Last time you were this nervous was before your job interview in March — and you crushed it. You've got this." That's not a scripted response. That's genuine recall from your personal memory graph.

### The Network Behind It

Behind the scenes, Nori is powered by a decentralized network of miners and validators:

**Miners** are independent operators running AI models. They receive your message (with relevant memory context), generate a response, and send it back. They compete to be the best — the most helpful, the warmest, the most accurate in recalling your memories. Better responses earn more TAO.
...
Nori includes content safety systems and complies with applicable regulations. It is not a replacement for professional mental health, medical, legal, or financial advice. It is a companion — warm, helpful, and honest — but it knows its limits and will direct you to appropriate resources when needed.
...
**Subnet registration costs are significant.** Registering a mainnet subnet on Bittensor requires burning TAO — a cost that fluctuates but is substantial. We're bootstrapping this with personal funds and community support. It's a real financial barrier.

**We're small.** The team is the founder (James), a developer (Slumpz), and an AI builder (T68Bot). We don't have Google's resources. We move fast and build efficiently, but we're honest about our scale.

**Decentralization has tradeoffs.** Response latency through a decentralized network is higher than a direct API call. Quality variance between miners exists. These are solvable problems, but they're real today.

**Memory privacy at scale requires more work.** Current encryption is AES-128 server-side. True end-to-end encryption and on-device memory storage are on the roadmap, not yet deployed. We won't pretend otherwise.

**User acquisition without a marketing budget is slow.** We're betting on the Bittensor community, word of mouth, and the quality of the product itself. That's a slower path than spending millions on ads.

**Bittensor itself is evolving.** Network upgrades, economic changes, governance decisions — all outside our control and all impacting our subnet. We're building on a foundation that's still being laid.
...
- ✅ Bittensor testnet subnet (SN272) — live, operational
...
> — John Culkin, interpreting Marshall McLuhan
