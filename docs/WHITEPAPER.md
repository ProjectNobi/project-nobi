...
| Component | Weight | Method |
|-----------|--------|--------|
| Quality + Personality | 0.50 | LLM-as-judge |
| Memory Integration | 0.25 | LLM-as-judge for contextual memory use |
| Memory Recall | 0.15 | Keyword verification with word-boundary matching |
