...
TIERS = {
    "free": {
        ...
        "group_mode": True,  # Groups available to all
        "max_tokens": int(os.environ.get("NOBI_MAX_RESPONSE_TOKENS", "512")),
    },
    "plus": {
        "name": "Plus",
        "price": 0,
        "price_label": "Free",
        "messages_per_day": int(os.environ.get("NOBI_PLUS_MESSAGES_PER_DAY", "900")),
        "memory_slots": int(os.environ.get("NOBI_PLUS_MEMORY_SLOTS", "900")),
        "voice_per_day": int(os.environ.get("NOBI_PLUS_VOICE_PER_DAY", "90")),
        "image_per_day": int(os.environ.get("NOBI_PLUS_IMAGE_PER_DAY", "90")),
        "proactive_messages": True,
        "priority_response": True,
        "export_memories": True,
        "group_mode": True,
        "max_tokens": int(os.environ.get("NOBI_PLUS_MAX_RESPONSE_TOKENS", "1536")),
    },
    "pro": {
        "name": "Pro",
        "price": 0,
        "price_label": "Free",
        "messages_per_day": int(os.environ.get("NOBI_PRO_MESSAGES_PER_DAY", "2700")),
        "memory_slots": int(os.environ.get("NOBI_PRO_MEMORY_SLOTS", "2700")),
        "voice_per_day": int(os.environ.get("NOBI_PRO_VOICE_PER_DAY", "270")),
        "image_per_day": int(os.environ.get("NOBI_PRO_IMAGE_PER_DAY", "270")),
        "proactive_messages": True,
        "priority_response": True,
        "export_memories": True,
        "group_mode": True,
        "max_tokens": int(os.environ.get("NOBI_PRO_MAX_RESPONSE_TOKENS", "4608")),
    },
    "lifetime": {
        "name": "Lifetime",
        "price": 0,
