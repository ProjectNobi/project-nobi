    ...
    <div key="welcome" className="text-center space-y-6 animate-fade-in">
      ...
      <label className="flex items-start gap-3 max-w-sm mx-auto text-left cursor-pointer">
        ...
        <span className="text-sm text-gray-600 dark:text-gray-400">
          I confirm I am <strong>18 or older</strong>. (If you are under 18 years old,
          you may not use this service.) I agree to the{" "}
          <a href="https://projectnobi.ai/terms.html" className="text-purple-600 dark:text-purple-400 underline" target="_blank" rel="noopener noreferrer">
            Terms of Service
          </a>{" "}
          and{" "}
          <a href="https://projectnobi.ai/privacy.html" className="text-purple-600 dark:text-purple-400 underline" target="_blank" rel="noopener noreferrer">
            Privacy Policy
          </a>
          .
        </span>
